package com.centit.file.utils.mybatisPlusGenerator;
...
public class GeneratorConstants {
     ...
     * 项目路径
     **/
    public static final String PROJECT_DIR = "D:\\develop\\IdeaProjects\\jsdjy\\SRC\\jsdjy-cloud/file-server";
    /**
     * java类目录
     **/
     ...
     * 指定生成的表 ， 用 ","分割
     **/
    public static final String TABLES = "ticket_project_img";
    /**
     * 模块名称
     **/
     ...
     * 父级包名
     **/
    public static final String PARENT_PACKAGE = "com.centit.file";
    /**
