...
public class CRMConst {
    ...
    @Value("${crm.labels.roleType}")
    private  String labelsRoleType;
    @Value("${crm.labels.url}")
    ...
    public static String LABELS_ROLETYPE;//TODO 	会员标签
    public static String LABELS_URL;//TODO
    ...
    public void init(){
        ...
        LABELS_ROLETYPE = labelsRoleType;
