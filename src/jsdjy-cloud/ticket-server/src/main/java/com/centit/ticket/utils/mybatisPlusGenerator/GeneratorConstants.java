...
public class GeneratorConstants {
     ...
     * 项目路径
     **/
    public static final String PROJECT_DIR = "D:/develop/workspace/jsdjy/SRC/jsdjy-cloud/ticket-server";
    /**
     * java类目录
     **/
     ...
     * 模块名称
     **/
    public static final String MODULE = "ticket";
    /**
     * 父级包名
     **/
     ...
     **/
    public static final String CHILD_PACKAGE_CONTROLLER = "webmgr.controller";
    /**
     ...
     **/
    public static final String CHILD_PACKAGE_SERVICE = "webmgr.service";
    /**
     * 子级service.impl服务接口实现类文件所在包名。释义:生成的service.impl服务接口实现类文件所在文件夹的名字
     **/
    public static final String CHILD_PACKAGE_SERVICEIMPL = "webmgr.service.impl";
