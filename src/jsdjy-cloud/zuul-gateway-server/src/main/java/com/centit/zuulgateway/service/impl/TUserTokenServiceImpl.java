...
import com.centit.zuulgateway.dao.TUserTokenDao;
import com.centit.zuulgateway.service.TUserTokenService;
...
public class TUserTokenServiceImpl implements TUserTokenService {
    public static final Log log = LogFactory.getLog(TUserTokenService.class);
