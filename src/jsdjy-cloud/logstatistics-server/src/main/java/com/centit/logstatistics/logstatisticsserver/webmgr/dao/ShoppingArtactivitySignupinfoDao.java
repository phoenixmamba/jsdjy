...
import com.centit.logstatistics.logstatisticsserver.webmgr.po.ShoppingArtactivitySignupinfo;
...
public interface ShoppingArtactivitySignupinfoDao {
    ...
    List<ShoppingArtactivitySignupinfo> querySignupinfoByOfId(String ofId);
}
