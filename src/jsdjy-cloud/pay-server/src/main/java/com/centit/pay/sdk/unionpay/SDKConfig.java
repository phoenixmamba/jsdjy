 ...
 * =============================================================================
 */
package com.centit.pay.sdk.unionpay;
...
//			in = SDKConfig.class.getClassLoader().getResourceAsStream(SDKConfig.class.getClassLoader().getResource("").getPath()+FILE_NAME);
			if (null != in) {
				properties = new Properties();
				try {
					properties.load(in);
