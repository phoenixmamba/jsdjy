package com.centit.pay.utils.mybatisPlusGenerator;
...
public class GeneratorConstants {
     ...
     * 项目路径
     **/
    public static final String PROJECT_DIR = "D:/develop/workspace/jsdjy/SRC/jsdjy-cloud/pay-server";
    /**
     * java类目录
     **/
...
//    public static final String DB_URL = "jdbc:mysql://localhost:3306/shop_wnsc";
//    public static final String DB_USER_NAME = "cuijian";
//    public static final String DB_PASSWORD = "root";
    public static final String DB_DRIVER = "com.mysql.jdbc.Driver";
    public static final String DB_URL = "jdbc:mysql://192.168.136.33:3306/shop_jsdjytest";
    public static final String DB_USER_NAME = "root";
    public static final String DB_PASSWORD = "Centit@001";
    /**
     * 指定生成的表 ， 用 ","分割
     **/
    public static final String TABLES = "shopping_goods,shopping_artplan,shopping_artactivity";
    /**
     * 模块名称
     **/
     ...
     * 父级包名
     **/
    public static final String PARENT_PACKAGE = "com.centit.pay";
    /**
