...
public class PayUtil {
     ...
     *
     */
    public static Boolean checkNotifySign(String xmlstring,String API_KEY) {
        try {
            ...
            String sign = PayUtil.getSign("UTF-8", packageParams, API_KEY);
            if(CommUtil.isNull(paramMap.get("sign"))||!sign.equals(paramMap.get("sign"))){
                return false;
            }
        } catch (Exception e) {
            e.printStackTrace();
