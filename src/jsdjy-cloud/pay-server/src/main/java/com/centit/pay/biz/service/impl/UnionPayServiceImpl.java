...
import com.centit.pay.sdk.unionpay.AcpService;
import com.centit.pay.sdk.unionpay.LogUtil;
import com.centit.pay.sdk.unionpay.SDKConfig;
import com.centit.pay.utils.DemoBase;
...
public class UnionPayServiceImpl implements UnionPayService {
    public static final Log log = LogFactory.getLog(UnionPayService.class);
     ...
     */
    @Override
    public JSONObject testPay(JSONObject reqJson) {
        ...
        try {
            ...
            String merId = "777";
            String txnAmt = "1";
            String orderId = "202101119089";
            String txnTime = "20210111170201";
...
//            resp.getWriter().write("请求报文:<br/>"+reqMessage+"<br/>" + "应答报文:</br>"+rspMessage+"");
            ...
            bizDataJson.put("reqMessage",reqMessage);
            bizDataJson.put("rspMessage",rspMessage);
