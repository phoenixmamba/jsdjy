...
public class FileUtil {
    ...
    public final static String IMGEXT = "bmp,dib,jfif,jpe,jpeg,jpg,png,tif,tiff,ico";
...
//        CommonsMultipartFile scan = (CommonsMultipartFile) multipartRequest.getFile(filePath);
...
//            int t = 1;
//            if (t == 0) {
//                new QiniuUtil().upload(scan.getBytes(), fileName + "/" + saveFileName);
//            } else if (t == 1) {
//                PicBucketDemo.upfile(scan.getBytes(), saveFileName, fileName);
//            }
