...
public class HttpSendUtil {
    ...
    public static Boolean doGetForTest(String url) {
     ...
     * @return
     */
    public static Boolean doPostForTest(String url, String params) {
        CloseableHttpClient httpclient = HttpClients.custom().setConnectionManager(connMgr).setDefaultRequestConfig(requestConfig).build();
...
//            jsonObject = JSONObject.parseObject(out);
    ...
    public static void main(String[] args) throws IOException {
        String url ="http://ceshi.centit.com/locode/api/framework/system/ldap/login";
        JSONObject object= new JSONObject();
        object.put("password","980823.a");
        object.put("username","han_pf");
        object.put("ajax","true");

        System.out.println(post(object,url));
