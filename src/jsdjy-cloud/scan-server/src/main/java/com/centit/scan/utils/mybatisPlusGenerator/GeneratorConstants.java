package com.centit.scan.utils.mybatisPlusGenerator;
...
public class GeneratorConstants {
     ...
     * 项目路径
     **/
    public static final String PROJECT_DIR = "D:/develop/workspace/jsdjy/SRC/jsdjy-cloud/scan-server";
    /**
     * java类目录
     **/
     ...
     * 指定生成的表 ， 用 ","分割
     **/
    public static final String TABLES = "t_dingtalk_token";
    /**
     * 模块名称
     **/
    public static final String MODULE = "webmgr";
    /**
     * 父级包名
     **/
    public static final String PARENT_PACKAGE = "com.centit.scan";
    /**
